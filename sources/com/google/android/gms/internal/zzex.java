...
public interface zzex extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzex {
        ...
        private static class C0095zza implements zzex {
        ...
        public static zzex zzI(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzex)) ? new C0095zza(iBinder) : (zzex) queryLocalInterface;
        }
