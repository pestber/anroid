...
public interface zzni extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzni {
        ...
        private static class C0142zza implements zzni {
        ...
        public static zzni zzbH(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzni)) ? new C0142zza(iBinder) : (zzni) queryLocalInterface;
        }
