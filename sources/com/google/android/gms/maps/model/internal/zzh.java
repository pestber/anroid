...
public interface zzh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzh {
        ...
        private static class C0217zza implements zzh {
        ...
        public static zzh zzcO(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzh)) ? new C0217zza(iBinder) : (zzh) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 4:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IIndoorLevelDelegate");
                    boolean zza = zza(zzcO(parcel.readStrongBinder()));
                    parcel2.writeNoException();
