...
public interface zzn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzn {
        ...
        private static class C0202zza implements zzn {
        ...
        public static zzn zzcv(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzn)) ? new C0202zza(iBinder) : (zzn) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    boolean zza = zza(zzi.zza.zzcP(parcel.readStrongBinder()));
