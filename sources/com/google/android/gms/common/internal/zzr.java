...
public interface zzr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzr {
        ...
        private static class C0044zza implements zzr {
        ...
        public static zzr zzaI(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzr)) ? new C0044zza(iBinder) : (zzr) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    com.google.android.gms.dynamic.zzd zza = zza(zzd.zza.zzbg(parcel.readStrongBinder()), parcel.readInt(), parcel.readInt());
