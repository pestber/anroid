...
public interface zzff extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzff {
        ...
        private static class C0099zza implements zzff {
            ...
            public void zza(zzfe zzfeVar) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeStrongBinder(zzfeVar != null ? zzfeVar.asBinder() : null);
        ...
        public static zzff zzM(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzff)) ? new C0099zza(iBinder) : (zzff) queryLocalInterface;
        }
