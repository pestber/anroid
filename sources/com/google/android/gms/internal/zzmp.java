...
public interface zzmp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmp {
        ...
        private static class C0135zza implements zzmp {
        ...
        public static zzmp zzbA(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzmp)) ? new C0135zza(iBinder) : (zzmp) queryLocalInterface;
        }
