...
public interface zzot extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzot {
        ...
        private static class C0153zza implements zzot {
        ...
        public static zzot zzdm(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzot)) ? new C0153zza(iBinder) : (zzot) queryLocalInterface;
        }
