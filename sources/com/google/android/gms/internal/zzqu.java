...
public interface zzqu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzqu {
        ...
        private static class C0164zza implements zzqu {
        ...
        public static zzqu zzdJ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzqu)) ? new C0164zza(iBinder) : (zzqu) queryLocalInterface;
        }
