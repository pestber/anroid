...
public interface zzcx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcx {
        ...
        private static class C0086zza implements zzcx {
        ...
        public static zzcx zzC(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzcx)) ? new C0086zza(iBinder) : (zzcx) queryLocalInterface;
        }
