...
public interface zzjk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzjk {
        ...
        private static class C0113zza implements zzjk {
        ...
        public static zzjk zzas(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzjk)) ? new C0113zza(iBinder) : (zzjk) queryLocalInterface;
        }
