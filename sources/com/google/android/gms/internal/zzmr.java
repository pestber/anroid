...
public interface zzmr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmr {
        ...
        private static class C0137zza implements zzmr {
        ...
        public static zzmr zzbC(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzmr)) ? new C0137zza(iBinder) : (zzmr) queryLocalInterface;
        }
