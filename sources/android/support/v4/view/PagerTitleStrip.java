...
public class PagerTitleStrip extends ViewGroup implements ViewPager.Decor {
    ...
    void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        switch (vgrav2) {
            case 16:
                int paddedHeight = (stripHeight2 - paddingTop2) - paddingBottom;
                int centeredTop = (paddedHeight - maxTextHeight) / 2;
                int prevTop = centeredTop + prevTopOffset;
            ...
            case 80:
                ...
                int prevTop2 = bottomGravTop + prevTopOffset;
                ...
                break;
            default:
                int prevTop3 = paddingTop2 + prevTopOffset;
                int currTop3 = paddingTop2 + currTopOffset;
                int nextTop3 = paddingTop2 + nextTopOffset;
                vgrav = prevTop3;
                paddingTop = currTop3;
                stripHeight = nextTop3;
                break;
        }
        this.mCurrText.layout(currLeft, paddingTop, halfCurrWidth2, this.mCurrText.getMeasuredHeight() + paddingTop);
