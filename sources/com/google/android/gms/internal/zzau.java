...
public interface zzau extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzau {
        ...
        private static class C0073zza implements zzau {
        ...
        public static zzau zza(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzau)) ? new C0073zza(iBinder) : (zzau) queryLocalInterface;
        }
