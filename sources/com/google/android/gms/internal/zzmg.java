...
public interface zzmg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmg {
        ...
        private static class C0126zza implements zzmg {
        ...
        public static zzmg zzbr(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzmg)) ? new C0126zza(iBinder) : (zzmg) queryLocalInterface;
        }
