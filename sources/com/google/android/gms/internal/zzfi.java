...
public interface zzfi extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfi {
        ...
        private static class C0102zza implements zzfi {
        ...
        public static zzfi zzP(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzfi)) ? new C0102zza(iBinder) : (zzfi) queryLocalInterface;
        }
