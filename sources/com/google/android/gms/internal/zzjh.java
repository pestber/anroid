...
public interface zzjh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzjh {
        ...
        private static class C0111zza implements zzjh {
        ...
        public static zzjh zzan(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzjh)) ? new C0111zza(iBinder) : (zzjh) queryLocalInterface;
        }
