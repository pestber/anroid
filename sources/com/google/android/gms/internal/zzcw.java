...
public interface zzcw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcw {
        ...
        private static class C0085zza implements zzcw {
        ...
        public static zzcw zzB(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzcw)) ? new C0085zza(iBinder) : (zzcw) queryLocalInterface;
        }
