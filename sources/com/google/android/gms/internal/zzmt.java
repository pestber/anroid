...
public interface zzmt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmt {
        ...
        private static class C0139zza implements zzmt {
        ...
        public static zzmt zzbE(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzmt)) ? new C0139zza(iBinder) : (zzmt) queryLocalInterface;
        }
