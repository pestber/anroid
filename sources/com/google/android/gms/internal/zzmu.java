...
public interface zzmu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmu {
        ...
        private static class C0140zza implements zzmu {
        ...
        public static zzmu zzbF(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzmu)) ? new C0140zza(iBinder) : (zzmu) queryLocalInterface;
        }
