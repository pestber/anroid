...
public interface zzcu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcu {
        ...
        private static class C0083zza implements zzcu {
            ...
            public void zza(zzco zzcoVar) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeStrongBinder(zzcoVar != null ? zzcoVar.asBinder() : null);
        ...
        public static zzcu zzz(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzcu)) ? new C0083zza(iBinder) : (zzcu) queryLocalInterface;
        }
