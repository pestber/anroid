        ...
        while (i < count) {
            ...
            if (child == null) {
                ...
                switch (absoluteGravity & 7) {
                    case 1:
                        int childLeft3 = ((((childSpace - childWidth) / 2) + paddingLeft2) + lp.leftMargin) - lp.rightMargin;
                        childLeft = childLeft3;
                        break;
                    case 5:
                        int childLeft4 = childRight - childWidth;
                        int childLeft5 = lp.rightMargin;
                        childLeft = childLeft4 - childLeft5;
                        break;
                    default:
                ...
                paddingLeft = paddingLeft2;
                setChildFrame(child, childLeft, childTop3 + getLocationOffset(child), childWidth, childHeight);
                int childTop4 = childTop3 + childHeight + lp.bottomMargin + getNextLocationOffset(child);
